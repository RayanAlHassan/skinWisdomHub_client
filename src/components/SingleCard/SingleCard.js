...
const SingleCard = ({ product }) => {
  console.log("Product data:", product); // Log the product object
  ...
  return (
    ...
    <div className={style.container}>
      <div key={product._id} className={style.content}>
        <div className={style.left}>
          <img className={style.img} src={product.image} alt={product.brand} />
        </div>
        <div className={style.right}>
          <p className={style.subCategory}> {product.subCategoryID}</p>
          <p className={style.brand}>BRAND: {product.brand}</p>
          <p className={style.skinType}>Skin Type: {product.skinType}</p>
